...
def main():
    ...
    parser.add_argument('--train_module', type=str, default='', help='Name of module in the "train_settings/" folder.')  # bbreg 
    parser.add_argument('--train_name', type=str, default='', help='Name of the train settings file.')  # atom 
