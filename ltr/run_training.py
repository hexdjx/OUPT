...
def main():
    ...
    parser.add_argument('--train_module', type=str, default='FusionNet', help='Name of module in the "train_settings/" folder.')  # bbreg Verification
    parser.add_argument('--train_name', type=str, default='fusionnet', help='Name of the train settings file.')  # atom verification
