...
parser.add_argument('--tracker_param', type=str, default='proupt50')
...
class GOT_Tracker(GOT_Tracker):
    def __init__(self):
        super(GOT_Tracker, self).__init__(name='OUPT')  # GOT_Tracker
...
if __name__ == '__main__':
    ...
    experiment = ExperimentGOT10k('/media/hexdjx/907856427856276E/GOT-10k', subset='test')  # test val
