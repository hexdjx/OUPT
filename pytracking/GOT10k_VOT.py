...
parser.add_argument('--tracker_name', type=str, default='oupt')
parser.add_argument('--tracker_param', type=str, default='oupt50_vot18')
...
class GOT_Tracker(GOT_Tracker):
    def __init__(self):
        super(GOT_Tracker, self).__init__(name='OUPT')
...
if __name__ == '__main__':
    ...
    experiment = ExperimentVOT('/home/hexdjx/code/Tracking/pytracking/pytracking/VOT/vot2018-workspace/sequences',
