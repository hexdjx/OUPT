    ...
    def _track_sequence(self, tracker, seq, init_info):
        ...
        for frame_num, frame_path in enumerate(seq.frames[1:], start=1):
            ...
            if self.visdom is not None:
                ...
                self.visualize(frame_num, seq.ground_truth_rect[frame_num], image, out['target_bbox'], segmentation)
...
#############################################################
    ...
    #############################################################
        ...
        # img_path = abs_path + '/img_result/basketball-6/var_ratio/' + str(frame_num) + '.png'
